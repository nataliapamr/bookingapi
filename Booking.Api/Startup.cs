...
namespace Booking.Api
{
    public class Startup
    {
        ...
        {
            services.Configure<BookingDBSettings>(Configuration.GetSection(nameof(BookingDBSettings)));
            services.AddSingleton<IBookingDBSettings>(sp => sp.GetRequiredService<IOptions<BookingDBSettings>>().Value);
